...
public class ConsultarDietaActivity extends AppCompatActivity {
    ...
    EditText etxtIdPaciente, etxtNomePaciente, etxtSobrenomePaciente, etxtDescricao, etxtVencimento;
    Button btnPesquisarDieta;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consultar_dieta);

        requestQueue = Volley.newRequestQueue(this);

        etxtIdPaciente = findViewById(R.id.etxtPesquisa);
        ...
        btnPesquisarDieta = findViewById(R.id.btnPesquisar);



        btnPesquisarDieta.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void getDietas() {
        ...
        stringRequest = new StringRequest(Request.Method.POST, urlWebServicesDesenvolvimento,
            ...
            protected Map<String, String> getParams(){
                ...
                params.put("idPaciente", etxtIdPaciente.getText().toString());
                return params;
            }
        };
